...
class ScriptAST(ExprAST):
	...
	stmt: StatementASTUniquePtr # readwrite, the generated statement AST by the script
...
class UnaryExprAST(ExprAST):
	func: FunctionAST # readwrite, if the expression is an overloaded function call, the function to be called.
	# Otherise, None
